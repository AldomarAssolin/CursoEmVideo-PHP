...
<div class="main tarefas lista-de-tarefas">
            ...
            <div class="row row-cols-5">
                ...
                <div class="col-1 my-1">Ações</div>
            </div>
            </div>
            <?php
            ...
            <div class="container text-start">
                <div class="row row-cols-5">
                    ...
                    <div class="col-1 my-1 py-1 border-bottom">
                        <a href="<?php Echo URL ?>excluirPermanenteTarefa?id=<?php echo $registro["id"]; ?>" class="btn btn-danger mx-3"><i class="bi bi-trash3-fill" title="Excluir"></i></a>
                    </div>
                </div>
            </div>
